...
4. **Правила организации работы: создание рабочей директории**
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled.png)
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%201.png)
...
5. **Установка и импорт библиотек**
    ...
    *NumPy (Numerical Python) - это библиотека языка программирования Python, которая предоставляет полезные инструменты для работы с массивами, матрицами и другими типами данных, используемыми в научных вычислениях. В NumPy представлены функции для выполнения математических операций, линейной алгебры, обработки изображений и многое другое. Она является одной из основных библиотек для научных вычислений в Python.*
    ...
    - Установите нужную библиотеку, используя команду *pip:*
        ...
        ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%202.png)
        
    - Импортируйте библиотеку:
        
        ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%203.png)
...
1. **Типы: integer, float, string, bool, complex**
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%204.png)
...
3. Комментарии в Python начинаются со знака решетки (#) и продолжаются до конца строки. Комментарии игнорируются интерпретатором Python и используются для пояснения кода. Например:
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%205.png)
...
[gtm_csv](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled.csv)

[id-features](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled.xlsx)

[XYZ](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled.txt)

[merging](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%201.xlsx)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%206.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%207.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%208.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%209.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2010.png)

Или два способа обращения к **предпоследнему** стобцу будут эквиваленты: *df_txt.iloc[1:4, **-1**]* и  *df_txt.iloc[1:4,**2**]* 

![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2011.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2012.png)
...
![Запрос звучит так : “Покажи элементы первого столбца для строк с нулевой по вторую включительно](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2013.png)

Запрос звучит так : “Покажи элементы первого столбца для строк с нулевой по вторую включительно

![Запрос звучит так : “Покажи элементы с нулевого по первый столбцы включительно внутри строк с первой по третью включительно”](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2014.png)

Запрос звучит так : “Покажи элементы с нулевого по первый столбцы включительно внутри строк с первой по третью включительно”

![Запрос звучит так : “Начиная с нулевой строки, покажи каждую вторую строку (шаг = 2)”. Знак **::** и цифра следующая за ними указывает на шаг, с которым будет происходить фильтрации изначальной таблицы. Поскольку в указанном обращении после цифры y[0::2] отсутствует запятая, фильтрация будет применяться ко всем столбцам сразу.](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2015.png)

Запрос звучит так : “Начиная с нулевой строки, покажи каждую вторую строку (шаг = 2)”. Знак **::** и цифра следующая за ними указывает на шаг, с которым будет происходить фильтрации изначальной таблицы. Поскольку в указанном обращении после цифры y[0::2] отсутствует запятая, фильтрация будет применяться ко всем столбцам сразу.

![Запрос звучит так : Одновременно, для строк и столбцов, покажи все элементы с 1 по 5 строку/столбец включительно, при этом иди с шагом, равным двум”](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2016.png)
...
![Запрос звучит так: Начиная с первого слоя в 3Д массиве, покажи нулевую строку. Здесь, индексация обращения при фильтрации работает следующим образом [слой, строка, столбец]](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2017.png)
...
![Запрос звучит так: Начиная с перого слоя в 3Д массиве, покажи в каждом из них строки с нулевой до первой включительно для столбцов, начиная с первого по третий включительно](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2018.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2019.png)

![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2020.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2021.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2022.png)
...
# Процессы генерации последовательностей **+ Notebook**
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2023.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2024.png)
...
[find files with X in name](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%201.txt)
...
- Функция должна возвращать результат с помощью ключевого слова `return`. Если внутри функции не будет команды `return`,то выполнение любых операций в теле функции невозможно будет присвоить какой-либо переменной (см. картинку ниже).
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2025.png)
...
![Гистограмма распределения параметра beta_poro](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2026.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2027.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2028.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2029.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2030.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2031.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2032.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2033.png)
...
[acii irap grid](bb-python%201428eaff9a2347a6b20a4fc41893663d/Average_energy_-1.rar)

[las](bb-python%201428eaff9a2347a6b20a4fc41893663d/well_8.las)

[RSM](bb-python%201428eaff9a2347a6b20a4fc41893663d/FULL_TNAV__586.rar)

[PRT.rar](bb-python%201428eaff9a2347a6b20a4fc41893663d/PRT.rar)
...
- Загрузка файла с отбивками пластов
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2034.png)
...
- Когда все подготовительные процедуры выполнены, давайте напишем основной скрипт:
    ...
    **Результирующая таблица выглядит так:**
    ...
    ![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2035.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2036.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2037.png)
...
6. Список из наиболее необходимых разработчику ключей для визуализации и аналитики данных приведен в Excel файле.
    ...
    [Список нужных ключевых слов для RSM.xlsx](bb-python%201428eaff9a2347a6b20a4fc41893663d/%25D0%25A1%25D0%25BF%25D0%25B8%25D1%2581%25D0%25BE%25D0%25BA_%25D0%25BD%25D1%2583%25D0%25B6%25D0%25BD%25D1%258B%25D1%2585_%25D0%25BA%25D0%25BB%25D1%258E%25D1%2587%25D0%25B5%25D0%25B2%25D1%258B%25D1%2585_%25D1%2581%25D0%25BB%25D0%25BE%25D0%25B2_%25D0%25B4%25D0%25BB%25D1%258F_RSM.xlsx)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2038.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2039.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2040.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2041.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2042.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2043.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2044.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2045.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2046.png)
...
![Untitled](bb-python%201428eaff9a2347a6b20a4fc41893663d/Untitled%2047.png)
